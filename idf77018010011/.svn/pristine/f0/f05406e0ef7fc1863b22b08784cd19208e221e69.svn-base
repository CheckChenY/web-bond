...
class Reginster extends Component{
    ...
    render(){
        ...
        <div style={{background:`url(${icomImg01}) no-repeat`, backgroundSize:'100% 100%', position:'fixed',width:'100%', height:'100%', padding:'72px 78px'}}>
            <Row style={{borderRadius:'8px', height:'100%'}}>
                <Col span={14} style={{backgroundColor:'rgba(32,32,32,0.82)', height:'100%'}}>
                    <div style={{height:'18%'}}>
                        <div style={{display:'inline-block',width:'100%', height:'20%'}}/> {/*占行*/}
                        <div>
                            <div className='login-form-title-span'/>
                            <div className='login-form-title'>用户注册</div>
                        </div>
                    ...
                    <Form style={{ height:'67%'}} className='register-form'>
                        <Row>
                            <Col span={12} style={{padding:'0 20px 0 28px'}}>
                                <FormItem>
                                    <Input className='register-form-input' prefix={<Icon type="user" style={{fontSize:'18px', color: 'rgba(255,255,255)' }}  />} placeholder="请输入用户名" />
                            ...
                            <Col span={12} style={{padding:'0 28px 0 20px'}}>
                                <FormItem>
                                    <Input className='register-form-input' prefix={<Icon type="idcard" style={{fontSize:'18px', color: 'rgba(255,255,255)' }} />} placeholder="请输入姓名" />
                                </FormItem>
                                <FormItem>
                                    <Input className='register-form-input' prefix={<Icon type="mobile" style={{fontSize:'18px', color: 'rgba(255,255,255)' }}  />} placeholder="请输入手机" />
                                </FormItem>
                                <FormItem>
                                    {/* <Select defaultValue="Zhejiang" prefix={<Icon type="man" style={{fontSize:'18px', color: 'rgba(255,255,255)' }}  />}>
                                        <Option value="男">Zhejiang</Option>
                                ...
                                <FormItem>
                                    <Input className='register-form-input' prefix={<Icon type="compass" style={{fontSize:'18px', color: 'rgba(255,255,255)' }}  />} placeholder="请输入联系地址" />
                                </FormItem>
                            </Col>
                        </Row>
                        <Row style={{height:'40%', width:'50%', padding:'0 20px 0 28px'}} >
                            <div style={{display:'inline-block',width:'100%', height:'30%'}}/> {/*占行*/}
                            <FormItem className='register-form-agreement'>
                                <Checkbox>阅读并接受</Checkbox>
                                <a href="http://www.baidu.com" >《xxxxxxx协议》</a>及<a href="http://www.sina.com" >《xxxx声明》</a>
                            </FormItem>
                            <div style={{display:'inline-block',width:'100%', height:'20%'}}/> {/*占行*/}
                    ...
                    <div style={{height:'15%', display:'inline-block', width:'100%'}}>
                        <div style={{display:'inline-block',width:'100%', height:'50%'}}/> {/*占行*/}
                        <Col span={12}>
                            <Button className='register-form-back-homepage-button'>{'< 返回首页'}</Button>
                        </Col>
                        <Col span={12} className='register-form-versions'>版本：xxxxxxxx</Col>                            
                ...
                <Col span={10} style={{background:`url(${icomImg02}) no-repeat`, backgroundSize:'100% 100%', height:'100%'}}>
                <div style={{marginTop:'28px'}}>
                    <img src={icomImg03} alt="logo" style={{width:'36px', height:'36px', borderRadius:'50%', marginLeft:'30px'}}/>
                    <div className='register-top-text'>精胜债券数据资讯</div>
                </div>
