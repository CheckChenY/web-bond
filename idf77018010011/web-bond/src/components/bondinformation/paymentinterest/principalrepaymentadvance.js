...
import './principalrepaymentadvance.css';
...
class Principalrepaymentadvance extends Component{
        ...
        return(
            <div >
                <div style={{overflowX:'auto'}}>
                    <Table 
                        className='principal-repayment-advance-table'
                        size='middle'
                        dataSource={dataSource01}
                        pagination={false}
                        rowClassName={(record, index)=>(index%2===0?
                                (
                                    'principal-repayment-advance-table-row-one'
                                ):(
                                    'principal-repayment-advance-table-row-two'
                                ))}
                    >
                        <Column
                            title='收藏'
                            ...
                            render={(status,record) => 
                                (status?(
                                    <span>
                                        <Button className='principal-repayment-advance-collect-button'>
                ...
                <div style={{height:'40px'}}>
                    <Row>
                        <Col span={3}>
                            <div className='principal-repayment-advance-total'>显示{dataSource.length}条结果</div>
                        </Col>
                        <Col span={21} style={{textAlign:'center'}}>
                            <Pagination
                                className='principal-repayment-advance-pagination'
                                size="small" 
                                pageSize={15}
                                defaultCurrent={1}
...
export default Principalrepaymentadvance;