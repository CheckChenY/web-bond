...
class RightTwoTableThree extends Component{
    ...
    render(){
        ...
        return(
            <div >
                <div >
                    <Table 
                        className='righttwoTable-three-table'
                        size='middle'
                        dataSource={dataSource01}
                        pagination={false}
                        rowClassName={(record, index)=>(index%2===0?
                                (
                                    'righttwoTable-three-table-row-one'
                                ):(
                                    'righttwoTable-three-table-row-two'
                                ))}
                    >
                        <Column
                            title='发行日'
...
export default RightTwoTableThree;