...
class RightFourTableTwo extends Component{
    ...
    render(){
        ...
        return(
            <div >
                <div >
                    <Table 
                        className='rightfourTable-two-table'
                        size='middle'
                        dataSource={dataSource}
                        pagination={false}
                        rowClassName={(record, index)=>(index%2===0?
                                (
                                    'rightfourTable-two-table-row-one'
                                ):(
                                    'rightfourTable-two-table-row-two'
                                ))}
                    >
                        <Column
                            title='日期'
...
export default RightFourTableTwo;