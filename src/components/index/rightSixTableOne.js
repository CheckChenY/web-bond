...
const dataSource = [{
    ...
    debt_rating:<img src={icomImg} alt="删除" style={{width:'10px',height:'10px'}}/>,
    subject_rating:'C',
    guarantor_rating:'C',
    issuer:'永泰能源股份有限公司',
    guarantor:'永泰集团有限公司',
...
class RightSixTableOne extends Component{
    ...
    render(){
        ...
        return(
            <div >
                <div >
                    <Table 
                        className='rightsixTable-one-table'
                        size='middle'
                        dataSource={dataSource}
                        pagination={false}
                        rowClassName={(record, index)=>(index%2===0?
                                (
                                    'rightsixTable-one-table-row-one'
                                ):(
                                    'rightsixTable-one-table-row-two'
                                ))}
                    >
                        <Column
                            title='评级调整日期'
...
export default RightSixTableOne;