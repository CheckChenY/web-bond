...
class RightTwoTableTwo extends Component{
    ...
    render(){
        ...
        return(
            <div >
                <div >
                    <Table 
                        className='righttwoTable-two-table'
                        size='middle'
                        dataSource={dataSource01}
                        pagination={false}
                        rowClassName={(record, index)=>(index%2===0?
                                (
                                    'righttwoTable-two-table-row-one'
                                ):(
                                    'righttwoTable-two-table-row-two'
                                ))}
                    >
                        <Column
                            title='发行日'
...
export default RightTwoTableTwo;