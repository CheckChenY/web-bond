...
class RightThreeTableTwo extends Component{
    ...
    render(){
        ...
        return(
            <div >
                <div >
                    <Table 
                        className='rightthreeTable-two-table'
                        size='middle'
                        dataSource={dataSource01}
                        pagination={false}
                        rowClassName={(record, index)=>(index%2===0?
                                (
                                    'rightthreeTable-two-table-row-one'
                                ):(
                                    'rightthreeTable-two-table-row-two'
                                ))}
                    >
                        <Column
                            title='债券简称'
...
export default RightThreeTableTwo;