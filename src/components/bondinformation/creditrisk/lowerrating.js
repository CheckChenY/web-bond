...
class Lowerrating extends Component{
        ...
        return(
            <div >
                <div style={{overflowX:'auto'}}>
                    <Table 
                        className='lower-rating-table'
                        size='middle'
                        dataSource={dataSource01}
                        pagination={false}
                        rowClassName={(record, index)=>(index%2===0?
                                (
                                    'lower-rating-table-row-one'
                                ):(
                                    'lower-rating-table-row-two'
                                ))}
                    >
                        <Column
                            title='收藏'
                            ...
                            render={(status,record) => 
                                (status?(
                                    <span>
                                        <Button className='lower-rating-collect-button'>
                ...
                <div style={{height:'40px'}}>
                    <Row>
                        <Col span={3}>
                            <div className='lower-rating-total'>显示{dataSource.length}条结果</div>
                        </Col>
                        <Col span={21} style={{textAlign:'center'}}>
                            <Pagination
                                className='lower-rating-pagination'
                                size="small" 
                                pageSize={15}
                                defaultCurrent={1}
