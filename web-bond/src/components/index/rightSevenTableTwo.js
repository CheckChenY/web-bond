...
class RightSevenTableTwo extends Component{
    ...
    render(){
        ...
        return(
            <div >
                <div >
                    <Table 
                        className='rightsevenTable-two-table'
                        size='middle'
                        dataSource={dataSource}
                        pagination={false}
                        rowClassName={(record, index)=>(index%2===0?
                                (
                                    'rightsevenTable-two-table-row-one'
                                ):(
                                    'rightsevenTable-two-table-row-two'
                                ))}
                    >
                        <Column
                            title='发行日'
...
export default RightSevenTableTwo;