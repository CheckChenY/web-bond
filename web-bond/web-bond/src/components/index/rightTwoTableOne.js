...
class RightTwoTableOne extends Component{
    ...
    render(){
        ...
        return(
            <div >
                <div >
                    <Table 
                        className='righttwoTable-one-table'
                        size='middle'
                        dataSource={dataSource01}
                        pagination={false}
                        rowClassName={(record, index)=>(index%2===0?
                                (
                                    'righttwoTable-one-table-row-one'
                                ):(
                                    'righttwoTable-one-table-row-two'
                                ))}
                    >
                        <Column
                            title='发行日'
...
export default RightTwoTableOne;