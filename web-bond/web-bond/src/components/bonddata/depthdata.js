                ...
                <div style={{padding:'10px 10px', background:'#f2f2f2',marginBottom:'30px'}}>
                    <Row>
                        <Col span={4} style={{background:'#ffffff',position:'fixed',top:'60px'}}>
                            <div style={{height:'50px', lineHeight:'50px', borderBottom:'1px solid #e2e2e2'}}>
                                <div className='depth-data-title-span'></div>
                                <span className='depth-data-title'>深度资料</span>
                            </div>
                            <Anchor affix={true} offsetTop={100} onClick={callback} className='depth-data-anchor' >
