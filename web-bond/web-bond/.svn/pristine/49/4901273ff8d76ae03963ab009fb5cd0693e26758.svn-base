...
class Creditissuance extends Component{
        ...
        return(
            <div >
                <div style={{overflowX:'auto'}}>
                    <Table 
                        ...
                        rowClassName={(record, index)=>(index%2===0?
                                (
                                    'credit-issuance-table-row-one'
                                ):(
                                    'credit-issuance-table-row-two'
                                ))}
                    >
                        <Column
                            title='收藏'
                            ...
                            render={(status,record) => 
                                (status?(
                                    <span>
                                        <Button className='credit-issuance-collect-button'>
                ...
                <div style={{height:'40px'}}>
                    <Row>
                        <Col span={3}>
                            <div className='credit-issuance-total'>显示{dataSource.length}条结果</div>
                        </Col>
                        <Col span={21} style={{textAlign:'center'}}>
                            <Pagination
                                className='credit-issuance-pagination'
                                size="small" 
                                pageSize={15}
                                defaultCurrent={1}
